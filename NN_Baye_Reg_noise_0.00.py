...
model.load_weights('./NN_twocompart_checkpoints_0/my_checkpoint')
...
model = FeedForwardNetwork(2)
model.load_weights('./NN_nonlinear_checkpoints_0/my_checkpoint')
...
model = FeedForwardNetwork(2)
model.load_weights('./NN_lorenz_checkpoints_0/my_checkpoint')
