...
model.load_weights('./NN_twocompart_checkpoints_0.25/my_checkpoint')
...
model = FeedForwardNetwork(2)
model.load_weights('./NN_nonlinear_checkpoints_0.25/my_checkpoint')
...
print("the value of beta_1 in model_1 of nonlinear model is",start_1['beta_1'])
print("the value of z_1 in model_2 of nonlinear model is",start_2['z_1'])
print("the value of beta_1 in model_2 of nonlinear model is",start_2['beta_1'])

T, Y = create_data_lorenz(p=0.25)

model = FeedForwardNetwork(2)
model.load_weights('./NN_lorenz_checkpoints_0.25/my_checkpoint')
